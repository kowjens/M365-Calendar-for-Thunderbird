...
Der STANDARD-Build enthält **keine native Thunderbird-Kalenderintegration**. Die Kalender werden im **Microsoft-365-Space** verwendet. Ein zusätzlicher Teams-Meeting-Button in Thunderbirds eingebauter Kalenderansicht gehört nur zum NATIVE-Build.
