# M365 Calendar for Thunderbird V2.49 – GITHUB_NATIVE
...
- Custom Experiment API: **yes (`nativeCalendar`)**
- Microsoft Entra configuration: **supplied by the user/administrator**
- Functionality: STANDARD features plus deeper integration into Thunderbird's built-in Calendar view
