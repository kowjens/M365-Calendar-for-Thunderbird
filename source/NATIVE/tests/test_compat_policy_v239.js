...
if(m.version!=='2.0.39') throw new Error('version');
if(m.browser_specific_settings?.gecko?.strict_max_version) throw new Error('GitHub NATIVE must not impose strict_max_version in V2.39');
...
console.log('V2.39 NATIVE compatibility policy/options contract passed');
